...
<div class="container-fluid bg-3 text-center" id="shopping">    
    ...
    <!--<div class="row">
        <div class="col-sm-4">
            <img src="img/shopping1.jpg" class="img-responsive" style="width: 100%">
        </div>
        <div class="col-sm-4">
            <img src="img/shopping2.jpg" class="img-responsive" style="width: 100%">
        </div>
        <div class="col-sm-4">
            <img src="img/shopping3.jpg" class="img-responsive" style="width: 100%">
        </div>
        <div class="col-sm-4">
            <img src="img/shopping4.jpg" class="img-responsive" style="width: 100%">
        </div>
        <div class="col-sm-4">
            <img src="img/shopping5.jpg" class="img-responsive" style="width: 100%">
        </div>
        <div class="col-sm-4">
            <img src="img/shopping6.jpg" class="img-responsive" style="width: 100%">
        </div>
    </div> -->
    <?php	
